...
while entrada :
    ...
    if opcion == 1 :
        while entrada :
            utiles1 =input("ingrese el utiles ")
            cantidad1 = int(input("ingrese la cantidad de los utiles"))
            ...
            utiles.append(utiles1)
            utiles.append(cantidad1)
            utiles.append(precio1)
            listado.append(utiles)
            print (listado)
            if salida == 2 :
                break
